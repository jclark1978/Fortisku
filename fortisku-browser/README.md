...
- Interactive Bill of Materials drawer with per-line quantities, optional discounts, and XLSX export
...
6. Open the BOM drawer to review totals or export to XLSX. Open the full-screen view to edit per-line discount percentages before exporting.
